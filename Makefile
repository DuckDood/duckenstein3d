...
obj/main.o: src/main.c src/level.h
	${CC} src/main.c -c -o obj/main.o -Dres=${res} -Dxres=${xres} -Ddebug=${debug} -DBOBAMNT=${bob} -DFRES=${fres} 

build/3d: obj/main.o 
	gcc obj/main.o  -o build/3d -lGL -lSDL2 -lm -lSDL2_mixer 

obj/builder.o: src/builder.c
	${CC} src/builder.c -c -o obj/builder.o -Dres=${res} -Dxres=${xres} -Ddebug=${debug} -DBOBAMNT=${bob} -DFRES=${fres} 
